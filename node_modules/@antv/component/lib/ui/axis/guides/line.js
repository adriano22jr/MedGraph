...
function renderArc(container, attr, style, animate) {
    ...
    return container
        ...
        .data([{ d: getArcPath.apply(void 0, tslib_1.__spreadArray(tslib_1.__spreadArray([startAngle, endAngle], tslib_1.__read(center), false), [radius], false)) }], function (d, i) { return i; })
        .join(function (enter) {
        return enter
            .append('path')
