...
exports.getDefaultTooltipStyle = exports.getClassNames = void 0;
...
function getDefaultTooltipStyle(prefixCls) {
    ...
    return _a = {},
        ...
        _a[".".concat(CLASS_NAME.NAME_LABEL)] = tslib_1.__assign({ flex: 1 }, TEXT_OVERFLOW_STYLE),
        _a[".".concat(CLASS_NAME.VALUE)] = tslib_1.__assign({ display: 'inline-block', float: 'right', flex: 1, 'text-align': 'right', 'min-width': '28px', 'margin-left': '30px', color: 'rgba(0, 0, 0, 0.85)' }, TEXT_OVERFLOW_STYLE),
