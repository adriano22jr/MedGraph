import { __extends, __assign, __rest, __spreadArray, __read } from 'tslib';
import { AABB, isCSSRGB, parseColor, AbstractRendererPlugin } from '@antv/g-lite';
import { VertexAttributeBufferIndex, VertexAttributeLocation, BufferGeometry, Light, Material } from '@antv/g-plugin-device-renderer';
export { BufferGeometry, Fog, FogType, Light, Material, Mesh, ShaderMaterial, VertexAttributeBufferIndex, VertexAttributeLocation } from '@antv/g-plugin-device-renderer';
import { VertexStepMode, Format, CullMode } from '@antv/g-device-api';
export { AddressMode, BlendFactor, BlendMode, BufferFrequencyHint, ChannelWriteMask, CompareFunction, CullMode, Format, FrontFace, GL, MipmapFilterMode, PrimitiveTopology, SamplerFormatKind, StencilOp, TextureDimension, TextureUsage, VertexStepMode } from '@antv/g-device-api';
import { mat4, vec3, vec4 } from 'gl-matrix';

var ProceduralGeometry = /** @class */ (function (_super) {
    __extends(ProceduralGeometry, _super);
    function ProceduralGeometry(device, props) {
         ...
         */
        _this.flipYMatrix = mat4.fromScaling(mat4.create(), vec3.fromValues(1, -1, 1));
    ...
    ProceduralGeometry.prototype.applyMa4Position = function (mat, positions) {
        ...
        this.updateVertexBuffer(VertexAttributeBufferIndex.POSITION, VertexAttributeLocation.POSITION, 0, new Uint8Array(positions.buffer));
    };
    ProceduralGeometry.prototype.applyMa4Normal = function (mat, normals) {
        var v = vec4.create();
        var normalMatrix = mat4.copy(mat4.create(), mat);
        ...
        this.updateVertexBuffer(VertexAttributeBufferIndex.NORMAL, VertexAttributeLocation.NORMAL, 0, new Uint8Array(normals.buffer));
    };
    ...
    if (height > 0) {
        for (i = 0; i <= heightSegments; i++) {
            for (j = 0; j <= capSegments; j++) {
                ...
                bottom = vec3.fromValues(sinTheta * baseRadius, -height / 2.0, cosTheta * baseRadius);
                top = vec3.fromValues(sinTheta * peakRadius, height / 2.0, cosTheta * peakRadius);
...
var CubeGeometry = /** @class */ (function (_super) {
    ...
    function CubeGeometry(device, props) {
        if (props === void 0) { props = {}; }
        return _super.call(this, device, __assign({ width: 1, height: 1, depth: 1, widthSegments: 1, heightSegments: 1, depthSegments: 1 }, props)) || this;
    }
...
var SphereGeometry = /** @class */ (function (_super) {
    ...
    function SphereGeometry(device, props) {
        if (props === void 0) { props = {}; }
        return _super.call(this, device, __assign({ radius: 0.5, latitudeBands: 16, longitudeBands: 16 }, props)) || this;
    }
...
var TorusGeometry = /** @class */ (function (_super) {
    ...
    function TorusGeometry(device, props) {
        if (props === void 0) { props = {}; }
        return _super.call(this, device, __assign({ tubeRadius: 0.2, ringRadius: 0.3, segments: 30, sides: 20 }, props)) || this;
    }
...
var PlaneGeometry = /** @class */ (function (_super) {
    ...
    function PlaneGeometry(device, props) {
        if (props === void 0) { props = {}; }
        return _super.call(this, device, __assign({ width: 1, depth: 1, widthSegments: 5, depthSegments: 5 }, props)) || this;
    }
...
var CylinderGeometry = /** @class */ (function (_super) {
    ...
    function CylinderGeometry(device, props) {
        if (props === void 0) { props = {}; }
        return _super.call(this, device, __assign({ radius: 0.5, height: 1, heightSegments: 5, capSegments: 20 }, props)) || this;
    }
...
var ConeGeometry = /** @class */ (function (_super) {
    ...
    function ConeGeometry(device, props) {
        if (props === void 0) { props = {}; }
        return _super.call(this, device, __assign({ baseRadius: 0.5, peakRadius: 0, height: 1, heightSegments: 5, capSegments: 18 }, props)) || this;
    }
...
var CapsuleGeometry = /** @class */ (function (_super) {
    ...
    function CapsuleGeometry(device, props) {
        if (props === void 0) { props = {}; }
        return _super.call(this, device, __assign({ radius: 0.5, height: 1, heightSegments: 1, sides: 20 }, props)) || this;
    }
...
var AmbientLight = /** @class */ (function (_super) {
    ...
    function AmbientLight(_a) {
        ...
        _this = _super.call(this, __assign({ style: __assign({ fill: 'black' }, style) }, rest)) || this;
...
var DirectionalLight = /** @class */ (function (_super) {
    ...
    function DirectionalLight(_a) {
        ...
        var _this = this;
        var style = _a.style, rest = __rest(_a, ["style"]);
        _this = _super.call(this, __assign({ style: __assign({ direction: vec3.fromValues(0, -1, 0) }, style) }, rest)) || this;
...
var MeshBasicMaterial = /** @class */ (function (_super) {
    ...
    function MeshBasicMaterial(device, props) {
        var _a;
        var _this = _super.call(this, device, __assign({ vertexShader: vert$3, fragmentShader: frag$3, cullMode: CullMode.BACK }, props)) || this;
        _this.defines = __assign(__assign({}, _this.defines), { USE_UV: true, USE_MAP: false, USE_WIREFRAME: false, USE_FOG: false, USE_LIGHT: false });
...
var MeshPhongMaterial = /** @class */ (function (_super) {
    ...
    function MeshPhongMaterial(device, props) {
        var _a;
        var _this = _super.call(this, device, __assign({ vertexShader: vert$2, fragmentShader: frag$2, emissive: 'black', shininess: 30, specular: '#111111', bumpScale: 1, doubleSide: false }, props)) || this;
        ...
        var emissiveColor = parseColor(emissive);
        var specularColor = parseColor(specular);
        _this.setUniforms((_a = {
                u_Placeholder: null
            },
        ...
        _this.defines = __assign(__assign({}, _this.defines), { USE_LIGHT: true });
        return _this;
    }
    Object.defineProperty(MeshPhongMaterial.prototype, "emissive", {
        ...
        set: function (v) {
            ...
            var emissiveColor = parseColor(v);
            this.setUniforms((_a = {},
                _a[Uniform$2.EMISSIVE] = [
                    Number(emissiveColor.r) / 255,
                    Number(emissiveColor.g) / 255,
    ...
    Object.defineProperty(MeshPhongMaterial.prototype, "specular", {
        ...
        set: function (v) {
            ...
            var specularColor = parseColor(v);
            this.setUniforms((_a = {},
                _a[Uniform$2.SPECULAR] = [
                    Number(specularColor.r) / 255,
                    Number(specularColor.g) / 255,
...
var MeshLambertMaterial = /** @class */ (function (_super) {
    ...
    function MeshLambertMaterial(device, props) {
        var _a;
        var _this = _super.call(this, device, __assign({ vertexShader: vert$1, fragmentShader: frag$1, emissive: 'black', bumpScale: 1, doubleSide: false }, props)) || this;
...
var PointMaterial = /** @class */ (function (_super) {
    ...
    function PointMaterial(device, props) {
        var _a;
        var _this = _super.call(this, device, __assign({ vertexShader: vert, fragmentShader: frag, cullMode: CullMode.BACK }, props)) || this;
        _this.defines = __assign(__assign({}, _this.defines), { USE_UV: true, USE_MAP: false, USE_WIREFRAME: false, USE_FOG: false, USE_LIGHT: false });
...
export { AmbientLight, CapsuleGeometry, ConeGeometry, CubeGeometry, CylinderGeometry, DirectionalLight, MeshBasicMaterial, MeshLambertMaterial, MeshPhongMaterial, PlaneGeometry, Plugin, PointMaterial, ProceduralGeometry, SphereGeometry, TorusGeometry };
