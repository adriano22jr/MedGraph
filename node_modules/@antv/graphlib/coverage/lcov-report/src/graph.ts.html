...
<head>
    <title>Code coverage report for src/graph.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> graph.ts</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">48.3% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>171/354</span>
            </div>
        
            
            <div class='fl pad1y space-right2'>
                <span class="strong">17.1% </span>
                <span class="quiet">Branches</span>
                <span class='fraction'>13/76</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                <span class="strong">48.97% </span>
                <span class="quiet">Lines</span>
                <span class='fraction'>167/341</span>
            </div>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import EventEmitter from '@antv/event-emitter';
...
&nbsp;
  ...
  constructor(options?: GraphOptions&lt;N, E&gt;) {
    super();
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!options) <span class="cstat-no" title="statement not covered" >return;</span>
    if (options.nodes) this.addNodes(options.nodes);
    if (options.edges) this.addEdges(options.edges);
    <span class="missing-if-branch" title="if path not taken" >I</span>if (options.tree) <span class="cstat-no" title="statement not covered" >this.addTree(options.tree);</span>
    <span class="missing-if-branch" title="if path not taken" >I</span>if (options.onChanged) <span class="cstat-no" title="statement not covered" >this.onChanged = options.onChanged;</span>
  }
&nbsp;
  /**
...
&nbsp;
   ...
   */
  public <span class="fstat-no" title="function not covered" >reduceChanges(</span>changes: GraphChange&lt;N, E&gt;[]): GraphChange&lt;N, E&gt;[] {
    let mergedChanges: GraphChange&lt;N, E&gt;[] = <span class="cstat-no" title="statement not covered" >[];</span>
<span class="cstat-no" title="statement not covered" >    changes.forEach(<span class="fstat-no" title="function not covered" >(c</span>hange) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      switch (change.type) {</span>
        case 'NodeRemoved': {
          // NodeAdded: A added.
          ...
          let isNewlyAdded = <span class="cstat-no" title="statement not covered" >false;</span>
<span class="cstat-no" title="statement not covered" >          mergedChanges = mergedChanges.filter(<span class="fstat-no" title="function not covered" >(p</span>astChange) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >            if (pastChange.type === 'NodeAdded') {</span>
              const sameId = <span class="cstat-no" title="statement not covered" >pastChange.value.id === change.value.id;</span>
<span class="cstat-no" title="statement not covered" >              <span class="missing-if-branch" title="if path not taken" >I</span>if (sameId) {</span>
<span class="cstat-no" title="statement not covered" >                isNewlyAdded = true;</span>
              }
<span class="cstat-no" title="statement not covered" >              return !sameId;</span>
            } else <span class="cstat-no" title="statement not covered" >if (pastChange.type === 'NodeDataUpdated') {</span>
<span class="cstat-no" title="statement not covered" >              return pastChange.id !== change.value.id;</span>
            } else <span class="cstat-no" title="statement not covered" ><span class="missing-if-branch" title="if path not taken" >I</span>if (pastChange.type === 'TreeStructureChanged') {</span>
<span class="cstat-no" title="statement not covered" >              return pastChange.nodeId !== change.value.id;</span>
            }
<span class="cstat-no" title="statement not covered" >            return true;</span>
          });
<span class="cstat-no" title="statement not covered" >          <span class="missing-if-branch" title="if path not taken" >I</span>if (!isNewlyAdded) {</span>
<span class="cstat-no" title="statement not covered" >            mergedChanges.push(change);</span>
          }
<span class="cstat-no" title="statement not covered" >          break;</span>
        ...
        case 'EdgeRemoved': {
          ...
          let isNewlyAdded = <span class="cstat-no" title="statement not covered" >false;</span>
<span class="cstat-no" title="statement not covered" >          mergedChanges = mergedChanges.filter(<span class="fstat-no" title="function not covered" >(p</span>astChange) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >            if (pastChange.type === 'EdgeAdded') {</span>
              const sameId = <span class="cstat-no" title="statement not covered" >pastChange.value.id === change.value.id;</span>
<span class="cstat-no" title="statement not covered" >              <span class="missing-if-branch" title="if path not taken" >I</span>if (sameId) {</span>
<span class="cstat-no" title="statement not covered" >                isNewlyAdded = true;</span>
              }
...
<span class="cstat-no" title="statement not covered" >          break;</span>
        ...
        case 'EdgeUpdated': {
          ...
          const index = <span class="cstat-no" title="statement not covered" >mergedChanges.findIndex(<span class="fstat-no" title="function not covered" >(p</span>astChange) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >            return (</span>
          ...
          const existingChange = <span class="cstat-no" title="statement not covered" >mergedChanges[index];</span>
<span class="cstat-no" title="statement not covered" >          if (existingChange) {</span>
<span class="cstat-no" title="statement not covered" >            if (change.propertyName !== undefined) {</span>
              // The incoming change is of the same property of existing change.
              (<span class="cstat-no" title="statement not covered" >existingChange as NodeDataUpdated&lt;N&gt;).newValue = change.newValue;</span>
            } else {
              // The incoming change is a whole data override.
<span class="cstat-no" title="statement not covered" >              mergedChanges.splice(index, 1);</span>
<span class="cstat-no" title="statement not covered" >              mergedChanges.push(change);</span>
            }
          } else {
<span class="cstat-no" title="statement not covered" >            mergedChanges.push(change);</span>
...
<span class="cstat-no" title="statement not covered" >          mergedChanges = mergedChanges.filter(<span class="fstat-no" title="function not covered" >(p</span>astChange) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >            if (pastChange.type === 'TreeStructureAttached') {</span>
<span class="cstat-no" title="statement not covered" >              return pastChange.treeKey !== change.treeKey;</span>
            } else <span class="cstat-no" title="statement not covered" ><span class="missing-if-branch" title="if path not taken" >I</span>if (pastChange.type === 'TreeStructureChanged') {</span>
<span class="cstat-no" title="statement not covered" >              return pastChange.treeKey !== change.treeKey;</span>
            }
<span class="cstat-no" title="statement not covered" >            return true;</span>
...
<span class="cstat-no" title="statement not covered" >          break;</span>
        ...
        case 'TreeStructureChanged': {
          const existingChange = <span class="cstat-no" title="statement not covered" >mergedChanges.find(<span class="fstat-no" title="function not covered" >(p</span>astChange) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >            return (</span>
...
<span class="cstat-no" title="statement not covered" >          if (existingChange) {</span>
            (<span class="cstat-no" title="statement not covered" >existingChange as TreeStructureChanged).newParentId =</span>
              change.newParentId;
          } else {
<span class="cstat-no" title="statement not covered" >            mergedChanges.push(change);</span>
          }
...
<span class="cstat-no" title="statement not covered" >    return mergedChanges;</span>
  }
&nbsp;
  // ================= Node =================
...
&nbsp;
   ...
   * @group NodeMethods
   */
  public <span class="fstat-no" title="function not covered" >areNeighbors(</span>firstNodeId: ID, secondNodeId: ID): boolean {
<span class="cstat-no" title="statement not covered" >    return this.getNeighbors(secondNodeId).some(</span>
<span class="fstat-no" title="function not covered" >      (n</span>eighbor) =&gt; <span class="cstat-no" title="statement not covered" >neighbor.id === firstNodeId,</span>
    );
  }
&nbsp;
  /**
...
<span class="cstat-no" title="statement not covered" >      throw new Error('Node not found for id: ' + id);</span>
    }
    return node;
  }
&nbsp;
...
&nbsp;
   ...
   * @group NodeMethods
   */
  public <span class="fstat-no" title="function not covered" >getDegree(</span>id: ID, direction?: 'in' | 'out' | 'both'): number {
<span class="cstat-no" title="statement not covered" >    return this.getRelatedEdges(id, direction).length;</span>
  }
&nbsp;
  /**
   * Get all successors of the given node.
   */
  public <span class="fstat-no" title="function not covered" >getSuccessors(</span>id: ID): Node&lt;N&gt;[] {
    const outEdges = <span class="cstat-no" title="statement not covered" >this.getRelatedEdges(id, 'out');</span>
    const targets = <span class="cstat-no" title="statement not covered" >outEdges.map(<span class="fstat-no" title="function not covered" >(e</span>dge) =&gt; <span class="cstat-no" title="statement not covered" >this.getNode(edge.target))</span>;</span>
<span class="cstat-no" title="statement not covered" >    return Array.from(new Set(targets));</span>
  }
&nbsp;
  /**
   * Get all predecessors of the given node.
   */
  public <span class="fstat-no" title="function not covered" >getPredecessors(</span>id: ID): Node&lt;N&gt;[] {
    const inEdges = <span class="cstat-no" title="statement not covered" >this.getRelatedEdges(id, 'in');</span>
    const sources = <span class="cstat-no" title="statement not covered" >inEdges.map(<span class="fstat-no" title="function not covered" >(e</span>dge) =&gt; <span class="cstat-no" title="statement not covered" >this.getNode(edge.source))</span>;</span>
<span class="cstat-no" title="statement not covered" >    return Array.from(new Set(sources));</span>
  }
&nbsp;
  /**
   ...
   * @group NodeMethods
   */
  public <span class="fstat-no" title="function not covered" >getNeighbors(</span>id: ID): Node&lt;N&gt;[] {
    const predecessors = <span class="cstat-no" title="statement not covered" >this.getPredecessors(id);</span>
    const successors = <span class="cstat-no" title="statement not covered" >this.getSuccessors(id);</span>
<span class="cstat-no" title="statement not covered" >    return Array.from(new Set([...predecessors, ...successors]));</span>
  }
&nbsp;
  private doAddNode(node: Node&lt;N&gt;): void {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.hasNode(node.id)) {
<span class="cstat-no" title="statement not covered" >      throw new Error('Node already exists: ' + node.id);</span>
    }
    this.nodeMap.set(node.id, node);
    this.inEdgesMap.set(node.id, new Set());
    this.outEdgesMap.set(node.id, new Set());
    this.bothEdgesMap.set(node.id, new Set());
    this.treeIndices.forEach(<span class="fstat-no" title="function not covered" >(t</span>ree) =&gt; {
<span class="cstat-no" title="statement not covered" >      tree.childrenMap.set(node.id, new Set());</span>
    });
...
&nbsp;
  private doRemoveNode(id: ID): void {
    ...
    this.treeIndices.forEach(<span class="fstat-no" title="function not covered" >(t</span>ree) =&gt; {
<span class="cstat-no" title="statement not covered" >      tree.childrenMap.get(id)?.forEach(<span class="fstat-no" title="function not covered" >(c</span>hild) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        tree.parentMap.delete(child.id);</span>
      });
<span class="cstat-no" title="statement not covered" >      tree.parentMap.delete(id);</span>
<span class="cstat-no" title="statement not covered" >      tree.childrenMap.delete(id);</span>
    });
...
&nbsp;
   ...
   */
  public <span class="fstat-no" title="function not covered" >mergeNodeData(</span>id: ID, patch: Partial&lt;N&gt;): void {
<span class="cstat-no" title="statement not covered" >    this.batch(<span class="fstat-no" title="function not covered" >() =</span>&gt; {</span>
<span class="cstat-no" title="statement not covered" >      Object.entries(patch).forEach(<span class="fstat-no" title="function not covered" >([</span>propertyName, value]) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        this.updateNodeDataProperty(id, propertyName, value);</span>
      });
    });
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    if (typeof args[1] === 'function') {</span>
      // id, update
      const update = <span class="cstat-no" title="statement not covered" >args[1];</span>
<span class="cstat-no" title="statement not covered" >      data = update(node.data);</span>
    } else <span class="cstat-no" title="statement not covered" ><span class="missing-if-branch" title="if path not taken" >I</span>if (typeof args[1] === 'object') {</span>
      // id, data
<span class="cstat-no" title="statement not covered" >      data = args[1];</span>
    }
<span class="cstat-no" title="statement not covered" >    this.batch(<span class="fstat-no" title="function not covered" >() =</span>&gt; {</span>
      const oldValue = <span class="cstat-no" title="statement not covered" >node.data;</span>
      const newValue = <span class="cstat-no" title="statement not covered" >data;</span>
<span class="cstat-no" title="statement not covered" >      node.data = data;</span>
<span class="cstat-no" title="statement not covered" >      this.changes.push({</span>
        type: 'NodeDataUpdated',
        id,
        oldValue,
        newValue,
...
&nbsp;
  ...
  private checkEdgeExistence(id: ID): void {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.hasEdge(id)) {
<span class="cstat-no" title="statement not covered" >      throw new Error('Edge not found for id: ' + id);</span>
    }
  }
&nbsp;
  /**
...
&nbsp;
  private doAddEdge(edge: Edge&lt;E&gt;): void {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.hasEdge(edge.id)) {
<span class="cstat-no" title="statement not covered" >      throw new Error('Edge already exists: ' + edge.id);</span>
    }
...
&nbsp;
   ...
   * @group EdgeMethods
   */
  public <span class="fstat-no" title="function not covered" >addEdge(</span>edge: Edge&lt;E&gt;): void {
<span class="cstat-no" title="statement not covered" >    this.addEdges([edge]);</span>
  }
&nbsp;
...
&nbsp;
   ...
   * @group EdgeMethods
   */
  public <span class="fstat-no" title="function not covered" >removeEdges(</span>idList: ID[]): void {
<span class="cstat-no" title="statement not covered" >    this.batch(<span class="fstat-no" title="function not covered" >() =</span>&gt; {</span>
<span class="cstat-no" title="statement not covered" >      idList.forEach(<span class="fstat-no" title="function not covered" >(i</span>d) =&gt; <span class="cstat-no" title="statement not covered" >this.doRemoveEdge(id))</span>;</span>
    });
  }
&nbsp;
  /**
   ...
   * @group EdgeMethods
   */
  public <span class="fstat-no" title="function not covered" >removeEdge(</span>id: ID): void {
<span class="cstat-no" title="statement not covered" >    this.removeEdges([id]);</span>
  }
&nbsp;
  /**
   ...
   * @group EdgeMethods
   */
  public <span class="fstat-no" title="function not covered" >updateEdgeSource(</span>id: ID, source: ID): void {
    const edge = <span class="cstat-no" title="statement not covered" >this.getEdge(id);</span>
<span class="cstat-no" title="statement not covered" >    this.checkNodeExistence(source);</span>
    const oldSource = <span class="cstat-no" title="statement not covered" >edge.source;</span>
    const newSource = <span class="cstat-no" title="statement not covered" >source;</span>
<span class="cstat-no" title="statement not covered" >    this.outEdgesMap.get(oldSource)!.delete(edge);</span>
<span class="cstat-no" title="statement not covered" >    this.bothEdgesMap.get(oldSource)!.delete(edge);</span>
<span class="cstat-no" title="statement not covered" >    this.outEdgesMap.get(newSource)!.add(edge);</span>
<span class="cstat-no" title="statement not covered" >    this.bothEdgesMap.get(newSource)!.add(edge);</span>
<span class="cstat-no" title="statement not covered" >    edge.source = source;</span>
<span class="cstat-no" title="statement not covered" >    this.batch(<span class="fstat-no" title="function not covered" >() =</span>&gt; {</span>
<span class="cstat-no" title="statement not covered" >      this.changes.push({</span>
        type: 'EdgeUpdated',
        id,
...
<span class="cstat-no" title="statement not covered" >    if (typeof args[1] === 'function') {</span>
      // id, update
      const update = <span class="cstat-no" title="statement not covered" >args[1];</span>
<span class="cstat-no" title="statement not covered" >      data = update(edge.data);</span>
    } else <span class="cstat-no" title="statement not covered" ><span class="missing-if-branch" title="if path not taken" >I</span>if (typeof args[1] === 'object') {</span>
      // id, data
<span class="cstat-no" title="statement not covered" >      data = args[1];</span>
    }
<span class="cstat-no" title="statement not covered" >    this.batch(<span class="fstat-no" title="function not covered" >() =</span>&gt; {</span>
      const oldValue = <span class="cstat-no" title="statement not covered" >edge.data;</span>
      const newValue = <span class="cstat-no" title="statement not covered" >data;</span>
<span class="cstat-no" title="statement not covered" >      edge.data = data;</span>
<span class="cstat-no" title="statement not covered" >      this.changes.push({</span>
        type: 'EdgeDataUpdated',
        id,
        oldValue,
...
&nbsp;
   ...
   * @group EdgeMethods
   */
  public <span class="fstat-no" title="function not covered" >mergeEdgeData(</span>id: ID, patch: Partial&lt;E&gt;): void {
<span class="cstat-no" title="statement not covered" >    this.batch(<span class="fstat-no" title="function not covered" >() =</span>&gt; {</span>
<span class="cstat-no" title="statement not covered" >      Object.entries(patch).forEach(<span class="fstat-no" title="function not covered" >([</span>propertyName, value]) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        this.updateEdgeDataProperty(id, propertyName, value);</span>
      });
    });
  }
&nbsp;
  ...
  private checkTreeExistence(treeKey: string | undefined): void {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.hasTreeStructure(treeKey)) {
<span class="cstat-no" title="statement not covered" >      throw new Error('Tree structure not found for treeKey: ' + treeKey);</span>
    }
  }
&nbsp;
...
&nbsp;
  ...
  public attachTreeStructure(treeKey?: string): void {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.treeIndices.has(treeKey)) {
      // Already attached.
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
...
&nbsp;
   ...
   * @group TreeMethods
   */
  public <span class="fstat-no" title="function not covered" >detachTreeStructure(</span>treeKey?: string): void {
<span class="cstat-no" title="statement not covered" >    this.checkTreeExistence(treeKey);</span>
<span class="cstat-no" title="statement not covered" >    this.treeIndices.delete(treeKey);</span>
<span class="cstat-no" title="statement not covered" >    this.batch(<span class="fstat-no" title="function not covered" >() =</span>&gt; {</span>
<span class="cstat-no" title="statement not covered" >      this.changes.push({</span>
...
&nbsp;
   ...
   * @group TreeMethods
   */
  public <span class="fstat-no" title="function not covered" >addTree(</span>tree: TreeData&lt;N&gt; | TreeData&lt;N&gt;[], treeKey?: string): void {
<span class="cstat-no" title="statement not covered" >    this.batch(<span class="fstat-no" title="function not covered" >() =</span>&gt; {</span>
<span class="cstat-no" title="statement not covered" >      this.attachTreeStructure(treeKey);</span>
&nbsp;
      // Add Nodes
      const nodes: TreeData&lt;N&gt;[] = <span class="cstat-no" title="statement not covered" >[];</span>
      const stack = <span class="cstat-no" title="statement not covered" >Array.isArray(tree) ? tree : [tree];</span>
<span class="cstat-no" title="statement not covered" >      while (stack.length) {</span>
        const node = <span class="cstat-no" title="statement not covered" >stack.shift()!;</span>
...
<span class="cstat-no" title="statement not covered" >          stack.push(...node.children);</span>
        }
      }
<span class="cstat-no" title="statement not covered" >      this.addNodes(nodes);</span>
&nbsp;
      // Set parent for each child node.
<span class="cstat-no" title="statement not covered" >      nodes.forEach(<span class="fstat-no" title="function not covered" >(p</span>arent) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        parent.children?.forEach(<span class="fstat-no" title="function not covered" >(c</span>hild) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >          this.setParent(child.id, parent.id, treeKey);</span>
        });
      });
    });
  }
...
&nbsp;
  ...
  public getChildren(id: ID, treeKey?: string): Node&lt;N&gt;[] {
    ...
    return Array.from(children || <span class="branch-1 cbranch-no" title="branch not covered" >[])</span>;
  }
&nbsp;
  /**
...
&nbsp;
   ...
   */
  public <span class="fstat-no" title="function not covered" >getAncestors(</span>id: ID, treeKey?: string): Node&lt;N&gt;[] {
    const ancestors: Node&lt;N&gt;[] = <span class="cstat-no" title="statement not covered" >[];</span>
    let current = <span class="cstat-no" title="statement not covered" >this.getNode(id);</span>
    let parent: Node&lt;N&gt; | null;
    // eslint-disable-next-line no-cond-assign
<span class="cstat-no" title="statement not covered" >    while ((parent = this.getParent(current.id, treeKey))) {</span>
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (oldParent?.id === parent) <span class="cstat-no" title="statement not covered" >return;</span>
&nbsp;
    // New parent is undefined, unset parent for the node
    <span class="missing-if-branch" title="if path not taken" >I</span>if (parent === undefined) {
<span class="cstat-no" title="statement not covered" >      <span class="missing-if-branch" title="if path not taken" >I</span>if (oldParent) {</span>
<span class="cstat-no" title="statement not covered" >        tree.childrenMap.get(oldParent.id)?.delete(node);</span>
      }
<span class="cstat-no" title="statement not covered" >      tree.parentMap.delete(id);</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
...
&nbsp;
    // Set children
    <span class="missing-if-branch" title="if path not taken" >I</span>if (oldParent) {
<span class="cstat-no" title="statement not covered" >      tree.childrenMap.get(oldParent.id)?.delete(node);</span>
    }
...
&nbsp;
<span class="fstat-no" title="function not covered" >  dfsTree(</span>id: ID, fn: (node: Node&lt;N&gt;) =&gt; boolean | void, treeKey?: string) {
    const navigator = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >(n</span>odeId: ID) =&gt; <span class="cstat-no" title="statement not covered" >this.getChildren(nodeId, treeKey);</span></span>
<span class="cstat-no" title="statement not covered" >    return doDFS(this.getNode(id), new Set(), fn, navigator);</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  bfsTree(</span>id: ID, fn: (node: Node&lt;N&gt;) =&gt; boolean | void, treeKey?: string) {
    const navigator = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >(n</span>odeId: ID) =&gt; <span class="cstat-no" title="statement not covered" >this.getChildren(nodeId, treeKey);</span></span>
<span class="cstat-no" title="statement not covered" >    return doBFS([this.getNode(id)], new Set(), fn, navigator);</span>
  }
&nbsp;
  // ================= Graph =================
  /**
...
&nbsp;
  public <span class="fstat-no" title="function not covered" >bfs(</span>
    id: ID,
    fn: (node: Node&lt;N&gt;) =&gt; boolean | void,
    direction: 'in' | 'out' | 'both' = <span class="branch-0 cbranch-no" title="branch not covered" >'out',</span>
  ): boolean {
    const navigator = <span class="cstat-no" title="statement not covered" >{</span>
...
&nbsp;
  public <span class="fstat-no" title="function not covered" >dfs(</span>
    id: ID,
    fn: (node: Node&lt;N&gt;) =&gt; boolean | void,
    direction: 'in' | 'out' | 'both' = <span class="branch-0 cbranch-no" title="branch not covered" >'out',</span>
  ): boolean {
...
&nbsp;
  public <span class="fstat-no" title="function not covered" >clone(</span>): Graph&lt;N, E&gt; {
    // Make a shallow copy of nodes and edges.
    const newNodes = <span class="cstat-no" title="statement not covered" >this.getAllNodes().map(<span class="fstat-no" title="function not covered" >(o</span>ldNode) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      return { ...oldNode, data: { ...oldNode.data } };</span>
    });
    const newEdges = <span class="cstat-no" title="statement not covered" >this.getAllEdges().map(<span class="fstat-no" title="function not covered" >(o</span>ldEdge) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      return { ...oldEdge, data: { ...oldEdge.data } };</span>
    });
&nbsp;
    // Create a new graph with shallow copied nodes and edges.
    const newGraph = <span class="cstat-no" title="statement not covered" >new Graph&lt;N, E&gt;({</span>
      nodes: newNodes,
      edges: newEdges,
    });
&nbsp;
    // Add tree indices.
<span class="cstat-no" title="statement not covered" >    this.treeIndices.forEach(</span>
<span class="fstat-no" title="function not covered" >      ({</span> parentMap: oldParentMap, childrenMap: oldChildrenMap }, treeKey) =&gt; {
        const parentMap = <span class="cstat-no" title="statement not covered" >new Map&lt;ID, Node&lt;N&gt;&gt;();</span>
<span class="cstat-no" title="statement not covered" >        oldParentMap.forEach(<span class="fstat-no" title="function not covered" >(p</span>arent, key) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >          parentMap.set(key, newGraph.getNode(parent.id));</span>
        });
&nbsp;
        const childrenMap = <span class="cstat-no" title="statement not covered" >new Map&lt;ID, Set&lt;Node&lt;N&gt;&gt;&gt;();</span>
<span class="cstat-no" title="statement not covered" >        oldChildrenMap.forEach(<span class="fstat-no" title="function not covered" >(c</span>hildren, key) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >          childrenMap.set(</span>
            key,
            new Set(Array.from(children).map(<span class="fstat-no" title="function not covered" >(n</span>) =&gt; <span class="cstat-no" title="statement not covered" >newGraph.getNode(n.id))</span>),
          );
        });
&nbsp;
<span class="cstat-no" title="statement not covered" >        newGraph.treeIndices.set(treeKey, {</span>
          parentMap: parentMap,
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    return newGraph;</span>
  }
&nbsp;
  public <span class="fstat-no" title="function not covered" >toJSON(</span>): string {
