...
import { setDOMSize, isBrowser, AbstractRendererPlugin, CustomEvent, Group, AbstractRenderer } from '@antv/g-lite';
...
var ContextRegisterPlugin = /** @class */ (function (_super) {
    ...
    ContextRegisterPlugin.prototype.init = function () {
        ...
        this.context.deviceContribution = new WebGLDeviceContribution(__assign(__assign({}, ((config === null || config === void 0 ? void 0 : config.targets)
            ? {
...
var DEFAULT_EVENT = new CustomEvent('');
/**
...
var ARButton = /** @class */ (function () {
    ...
    ARButton.createButton = function (canvas, renderer, sessionInit) {
        ...
        var showStartAR = function () {
            ...
            var onSessionStarted = function (session) { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
...
var Renderer = /** @class */ (function (_super) {
    ...
    function Renderer(config) {
        ...
        var deviceRendererPlugin = new DeviceRenderer.Plugin(config);
...
export { ARButton, Renderer, WebXRManager };
