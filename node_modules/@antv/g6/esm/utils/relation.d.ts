 ...
 */
export declare function getElementNthDegreeIds(graph: Graph, elementType: ElementType, elementId: ID, degree: number): ID[];
/**
 ...
 * @returns - <zh/> 返回节点和边的 ID 数组 | <en/> Returns an array of node and edge IDs
 */
export declare function getNodeNthDegreeIds(graph: Graph, startNodeId: ID, degree: number): ID[];
