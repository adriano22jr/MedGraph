...
exports.getBoundingPoints = exports.sortByClockwise = exports.centerOf = exports.findNearestPointOnLine = exports.getDistanceToLine = exports.findNearestLine = exports.findNearestPoints = exports.getEllipseIntersectPoint = exports.getRectIntersectPoint = exports.isPointInPolygon = exports.getPolygonIntersectPoint = exports.isCollinear = exports.isOrthogonal = exports.isVertical = exports.isHorizontal = exports.moveTo = exports.round = exports.deduplicate = exports.sortByX = exports.toPointObject = exports.parsePoint = void 0;
 ...
 */
function getPolygonIntersectPoint(p, center, points, isRelativePos = true) {
    for (let i = 0; i < points.length; i++) {
        ...
        const intersect = (0, line_1.getLinesIntersection)([center, p], [start, end]);
        if (intersect) {
            return {
                point: intersect,
                line: [start, end],
 ...
 */
function getRectIntersectPoint(p, bbox) {
 ...
 * @returns <zh/> 交点 | <en/> intersection
 */
function getEllipseIntersectPoint(p, bbox) {
    const center = bbox.center;
    const vec = (0, vector_1.subtract)(p, bbox.center);
