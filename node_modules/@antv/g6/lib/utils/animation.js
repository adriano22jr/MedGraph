...
exports.getElementAnimationOptions = exports.getAnimationOptions = exports.inferDefaultValue = exports.preprocessKeyframes = exports.createAnimationsProxy = void 0;
...
function getAnimationOptions(options, localAnimation) {
    ...
    if (animation === false || localAnimation === false)
        return false;
    const effectTiming = { ...constants_1.DEFAULT_ANIMATION_OPTIONS };
    if ((0, util_1.isObject)(animation))
        Object.assign(effectTiming, animation);
    if ((0, util_1.isObject)(localAnimation))
...
function animationOf(options) {
    if ((0, util_1.isString)(options))
        return (0, registry_1.getExtension)(constants_1.ExtensionCategory.ANIMATION, options) || [];
    return options;
}
/**
 * <zh/> 获取元素的动画
...
function getElementAnimationOptions(options, elementType, stage, localAnimation) {
    ...
    const themeElementAnimation = (0, theme_1.themeOf)(options)[elementType]?.animation;
    const combine = (_ = []) => animationOf(_).map((animation) => ({
        ...constants_1.DEFAULT_ELEMENTS_ANIMATION_OPTIONS,
        ...((0, util_1.isObject)(globalAnimation) && globalAnimation),
        ...animation,
        ...((0, util_1.isObject)(localAnimation) && localAnimation),
    }));
