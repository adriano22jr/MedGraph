...
exports.getArrowSize = exports.findActualConnectNodeData = exports.getSubgraphRelatedEdges = exports.getPolylineLoopControlPoints = exports.getPolylineLoopPath = exports.getCubicLoopControlPoints = exports.getCubicLoopPath = exports.getLoopEndpoints = exports.getRadians = exports.getBorderRadiusPoints = exports.getPolylinePath = exports.getCubicPath = exports.getQuadraticPath = exports.parseCurvePosition = exports.parseCurveOffset = exports.getCurveControlPoint = exports.getBadgePositionStyle = exports.getLabelPositionStyle = void 0;
...
function getPolylineLoopControlPoints(node, sourcePoint, targetPoint, dist) {
    ...
    if ((0, util_1.isEqual)(sourcePoint, targetPoint)) {
        const side = (0, bbox_1.getNearestSideToPoint)(bbox, sourcePoint);
        switch (side) {
            case 'left':
        ...
        const sourceSide = (0, bbox_1.getNearestSideToPoint)(bbox, sourcePoint);
        const targetSide = (0, bbox_1.getNearestSideToPoint)(bbox, targetPoint);
