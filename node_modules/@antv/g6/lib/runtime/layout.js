...
class LayoutController {
    ...
    async graphLayout(data, options, index) {
        ...
        if (enableWorker) {
            ...
            return (0, layout_2.layoutMapping2GraphData)(await this.supervisor.execute());
        }
    ...
    async treeLayout(data, options, index) {
        ...
        const layout = (0, registry_1.getExtension)('layout', type);
        if (!layout)
            throw new Error(`The layout type ${type} is not found`);
    ...
    initGraphLayout(options) {
        ...
        const nodeSize = options?.nodeSize ??
            ((node) => {
                ...
                return Math.max(...(0, size_1.parseSize)(size));
            });
        const Ctor = (0, registry_1.getExtension)('layout', type);
        if (!Ctor)
            throw new Error(`The layout type ${type} is not found`);
