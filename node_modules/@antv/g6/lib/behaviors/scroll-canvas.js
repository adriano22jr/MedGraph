...
class ScrollCanvas extends base_behavior_1.BaseBehavior {
    ...
    bindEvents() {
        ...
        if ((0, util_1.isObject)(trigger)) {
            this.graphDom?.removeEventListener(constants_1.CommonEvent.WHEEL, this.onWheel);
             ...
             */
            this.graphDom?.addEventListener(constants_1.CommonEvent.WHEEL, this.onWheel, { passive: false });
        }
    }
    get graphDom() {
