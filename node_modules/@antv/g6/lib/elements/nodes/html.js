...
class HTML extends base_node_1.BaseNode {
    ...
    rootPointerEvent = new g_1.FederatedPointerEvent(null);
    get eventService() {
    ...
    getKeyStyle(attributes) {
        const style = (0, util_1.pick)(attributes, ['innerHTML', 'pointerEvents', 'cursor']);
    ...
    drawKeyShape(attributes, container) {
        ...
        const bounds = this.upsert('key-container', g_1.Rect, { width, height, opacity: 0 }, container);
    ...
    getViewportXY(nativeEvent) {
        ...
        if (this.attributes.context?.canvas.main.context.config.supportsCSSTransform &&
            !(0, util_1.isNil)(offsetX) &&
            !(0, util_1.isNil)(offsetY)) {
            x = offsetX;
            y = offsetY;
        }
        else {
