...
exports.getImageWatermark = exports.getTextWatermark = void 0;
 ...
 * @returns 水印的 base64
 */
async function getTextWatermark(width, height, text, style) {
 ...
 * @returns 水印的 base64
 */
async function getImageWatermark(width, height, imageURL, style) {
    const canvas = createCanvas(width, height);
    const ctx = canvas.getContext('2d');
