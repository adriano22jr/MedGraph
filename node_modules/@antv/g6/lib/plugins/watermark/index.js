...
class Watermark extends base_plugin_1.BasePlugin {
    ...
    $element = (0, dom_1.createPluginContainer)('watermark');
    ...
    async update(options) {
        ...
        const base64 = imageURL
            ? await (0, util_1.getImageWatermark)(width, height, imageURL, rest)
            : await (0, util_1.getTextWatermark)(width, height, text, rest);
