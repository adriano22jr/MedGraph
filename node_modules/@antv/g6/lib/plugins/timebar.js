...
class Timebar extends base_plugin_1.BasePlugin {
    ...
    upsertTimebar() {
        ...
        this.upsertCanvas().ready.then(() => {
            const style = {
                ...
                ...restOptions,
                data: data.map((datum) => ((0, util_1.isNumber)(datum) ? { time: datum, value: 0 } : datum)),
                width,
                height,
                type: timebarType,
            };
    ...
    upsertWrapper() {
        ...
        if ((0, util_1.isNumber)(x) || (0, util_1.isNumber)(y)) {
    ...
    upsertCanvas() {
        ...
        this.canvas = new g_1.Canvas({
            container: wrapper,
            width,
            height: height + top + bottom,
            renderer: this.context.options.renderer?.('main') || new g_canvas_1.Renderer(),
